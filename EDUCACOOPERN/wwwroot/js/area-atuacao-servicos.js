$(function () {
    ...
    function adicionarAreaAtuacao() {
        ...
        let idServicos = $(".servicos").val();
        let textServicos = $(".servicos option:selected").text();
        ...
        $("#lista-areas-atuacao").append(`
                    <tr class="row item-area-atuacao">
                        <td class="col-5">
                            ...
                            <input type="hidden" class="dados-item-area-atuacao" name="AreasAtuacao[0].ServicosId" value="${idServicos}" />
                            <input type="hidden" class="dados-item-area-atuacao" name="AreasAtuacao[0].ServicosNome" value="${textAreaAtuacao}" />
